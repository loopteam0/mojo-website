...
export class MediaAndPressComponent {
  ...
  mediaAndPress: NewsCards[] = [
    ...
    {newsImg: '/assets/images/news-img2.jpg', writerImg: '', writerName: '', newsDate: '11/09/2022', newsTitle: 'Health Insurance Premiums for Students for Fall 2023', newsSubTitle: "Students enrolled in any university in Lebanon, are required by law to be covered by health insurance.", newsLink: 'https://today.lorientlejour.com/article/1339336/digital-wallets-a-new-way-to-bypass-banks-in-lebanon.html'}
